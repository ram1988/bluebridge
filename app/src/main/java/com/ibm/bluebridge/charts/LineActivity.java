...
//        set1.setDrawFilled(true);
    ...
    private void takeScreenshot() {
        ...
        try {
            ...
            snapshotPath = Utils.getChartDir() + date + ".jpg";
    ...
    private void openScreenshot(File imageFile) {
        ...
        intent.putExtra(Intent.EXTRA_SUBJECT, "android - email with attachment");
        intent.putExtra(Intent.EXTRA_TEXT, "");
        intent.putExtra(Intent.EXTRA_STREAM, uri);
        this.startActivity(Intent.createChooser(intent, "Select application"));
    }
}
